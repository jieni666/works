...
if ($admin_id){
    $res2=$get_information->get_task_data($admin_id);
}
else{
    $res2=$get_information->get_task_data($id);
}
                    ...
                    <div id="wrapper" class="wrapper">
                        <div id="scroller" class="scroller">
                                ...
                                <table class="am-table  am-table-hover  am-table-striped am-text-nowrap am-scrollable-horizontal">
                                    ...
                                    <?php
                                    $i=1;
                                    foreach ($res2 as $arry){
                                        ?>
                                        <tr>
                                            <td><?php echo $i ?></td>
                                            <td><?php echo $arry['content'] ?></td>
                                            <td><?php echo $arry['username'] ?></td>
                                            <td><?php echo $arry['time'] ?></td>
                                        </tr>
                                        <?php
                                        $i++;
                        ...
                        <div class="am-tabs-bd">
                            <div class="am-tab-panel am-fade am-in am-active" id="tab1">
                                <div id="wrapperA" class="wrapper">
                                    <div id="scroller" class="scroller">
                                        <table class="am-table  am-table-hover  am-table-striped am-text-nowrap am-scrollable-horizontal am-text-truncate">
                                            <tr>
                                                <th>#</th>
                                                <th>内容</th>
                                                <th>发布时间</th>
