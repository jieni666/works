...
if ($admin_id){
    $res=$get_information->get_user_information($admin_id);
}else{
    $res=$get_information->get_user_information($id);
                    ...
                    $i=1;
                        foreach ($res as $arry){
                            ...
                            <tr>
                                ...
                                <td><?php echo $arry['email'] ?></td>
                                <td>
                                    <input class="del" type="hidden" value=" ">
                                    <a href="delete.php?id=<?php echo $arry['id'] ?>">删除</a>
                                </td>
                            </tr>
                    <?php
                            $i++;
